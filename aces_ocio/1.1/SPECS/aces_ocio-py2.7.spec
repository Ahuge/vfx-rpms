...
%install
pip2 install --install-option="--prefix=$RPM_BUILD_ROOT/usr/local" --verbose .

%files
%defattr(-,root,root)
/usr/local/lib/python2.7/site-packages/aces_ocio-1.0.1-py2.7.egg-info
/usr/local/lib/python2.7/site-packages/aces_ocio
